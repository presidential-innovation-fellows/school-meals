  ...
  render() {
    ...
    return (
      <Slide header="Gross Income" id="gross-income" showHelp={false}>
        ...
        <p className="usa-font-lead">The next section will ask you about the income of adults in your household. All of the income that you enter should be <strong>gross income</strong>.</p>

        <p><dfn>Gross income</dfn> means <strong>all money earned or received <em>before</em> deductions</strong> such as income taxes, social security taxes, and insurance premiums. You should <em>not</em> report net income, which is the amount of money received in a pay check. Net income is total (or gross) income, minus taxes and deductions, and is commonly referred to as "take home pay".</p>
