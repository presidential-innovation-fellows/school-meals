      ...
      <Slide header="Before you begin..." id="before-you-begin">
        ...
        {!!this.showExtraContent &&
         <div>
           ...
           <ul className="usa-content-list">
             <li>If you participate in {assistanceProgramsVar.snap.accronym}, {assistanceProgramsVar.tanf.accronym}, or {assistanceProgramsVar.fdpir.accronym} you will need to know your case number (not your card or account number).</li>
             <li>
